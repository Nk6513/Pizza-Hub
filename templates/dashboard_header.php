...
<nav class="teal z-depth-0">
    <div class="container">
        ...
        <ul class="right hide-on-small-and-down">
            <li class="white-text">Hello <?php echo htmlspecialchars($name); ?></li>
...
<section>
    ...
    <div class="col s3 sidebar z-depth-2 grey lighten-4" style="padding: 20px; border-radius: 8px;">
        ...
        <a href="dashboard.php" class="waves-effect waves-light btn-large green lighten-1 white-text" style="width: 100%; margin: 8px 0; text-align: left;">
            🏠 Dashboard
        </a>
        
        <a href="manage_pizzas.php" class="waves-effect waves-light btn-large blue lighten-1 white-text" style="width: 100%; margin: 8px 0; text-align: left;">
            🍕 Manage Pizzas
        </a>
