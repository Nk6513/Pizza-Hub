...
// fetch recent added pizza name title.
...
<div class="row" style="display:flex; flex-wrap:wrap; align-items:stretch;">
    ...
    <div class="col s12 m4" style="display:flex;">
        <div class="card blue lighten-4 z-depth-2 card-stats" style="flex:1; display:flex; flex-direction:column; justify-content:center;">
            <div class="card-content" style="text-align:center;">
                <h5 class="blue-text text-darken-3">Total Pizzas</h5>
                <h3 class="blue-text text-darken-4"><?php echo implode(',', $countPizzas); ?></h3>
            </div>
        </div>
    </div>
    ...
    <!-- Pending Orders -->
    <div class="col s12 m4" style="display:flex;">
        <div class="card amber lighten-4 z-depth-2 card-stats" style="flex:1; display:flex; flex-direction:column; justify-content:center;">
            <div class="card-content" style="text-align:center;">
    ...
    <!-- Recent Pizza -->
    <div class="col s12 m4" style="display:flex;">
        <div class="card green lighten-4 z-depth-2 card-stats" style="flex:1; display:flex; flex-direction:column; justify-content:center;">
            <div class="card-content" style="text-align:center;">
                <h5 class="green-text text-darken-3">Recent Pizza</h5>
                <h6 class="green-text text-darken-4" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                    <?php echo $recentPizza; ?>
                </h6>
                <p style="margin: 0; font-size: 0.85rem;">Created at: <?php echo $created_at; ?></p>
                <p style="margin: 0; font-size: 0.85rem;">Email: <?php echo $email; ?></p>
            </div>
        </div>
    </div>
